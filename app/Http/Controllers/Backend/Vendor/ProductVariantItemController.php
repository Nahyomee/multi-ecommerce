...
class ProductVariantItemController extends Controller
{
    ...
    public function index(ProductVariant $variant)
    {
        ...
        return $datatable->render('vendor.product.variants.items.index', compact('variant'));
    }
    ...
    public function create(ProductVariant $variant)
    {
        ...
        return view('vendor.product.variants.items.create', compact('variant'));
    }
    ...
    public function edit(ProductVariant $variant, ProductVariantItem $item)
    {
        ...
        return view('vendor.product.variants.items.edit', compact('variant', 'item'));
