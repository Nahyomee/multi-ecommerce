...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($product){
            $product->thumb_img = $this->uploadImage($request, Str::slug($product->name).rand(10,99), 'product', 'thumb_img');
            $product->save();
    ...
    public function edit(Product $product)
    {
        ...
        $brands = Brand::all();
        return view('admin.product.edit', compact('categories', 'brands', 'product', 'subcategories', 'child_categories'));
    }
    ...
    public function update(Request $request, Product $product)
    {
        ...
        if($product->update($request->except('thumb_img') + 
         ...
         ]))
         {
            ...
            $img = $this->updateImage($request, $filename, 'product', $oldPath, 'thumb_img');
            if($img != null){
