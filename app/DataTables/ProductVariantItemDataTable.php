...
class ProductVariantItemDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($query){
            $editBtn = "<a href='".route('admin.variants.items.edit', ['item' => $query, 'variant' => $query->variant])."' class='btn btn-sm btn-primary ml-2'><i class='fa fa-edit'></i></a>";
            $delBtn = "<a href='".route('admin.variants.items.destroy', ['item' => $query, 'variant' => $query->variant])."' class='btn btn-sm btn-danger delete-btn ml-2'><i class='fa fa-trash'></i></a>";
