...
class VendorPendingProductDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            ...
            $delBtn = "<a href='".route('vendor.products.destroy', ['product' => $query])."' class='btn btn-sm btn-danger delete-btn ml-1'><i class='fa fa-trash'></i></a>";
    ...
    public function query(Product $model): QueryBuilder
    {
        return $model->newQuery()->where('vendor_id', '<>', auth()->user()->vendor->id)
            ->where('is_approved', 0)->orderBy('created_at');
    }
