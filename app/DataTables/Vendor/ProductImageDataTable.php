...
class ProductImageDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($query) {
            return "<a href='".route('vendor.products.images.destroy', ['product' => $query->product, 'image' => $query])."' class='btn btn-sm btn-danger delete-btn ml-2'><i class='fa fa-trash'></i></a>";
