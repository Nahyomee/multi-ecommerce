...
class ChildCategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($query){
            $editBtn = "<a href='".route('admin.child-categories.edit', ['child_category' => $query])."' class='btn btn-primary'><i class='fa fa-edit'></i></a>";
            $delBtn = "<a href='".route('admin.child-categories.destroy', ['child_category' => $query])."' class='btn btn-danger delete-btn ml-2'><i class='fa fa-trash'></i></a>";
