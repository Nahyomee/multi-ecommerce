...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{route('vendor.products.variants.index', ['product' => $variant->product])}}">{{$variant->product->name}} Variants</a></div>
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-header-action">
                <a href="{{route('vendor.variants.items.create', ['variant' => $variant])}}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New </a>
            </div>
            </div>
            <div class="card-body">
              {{$dataTable->table()}}
