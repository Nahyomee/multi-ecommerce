        ...
        <div class="col-12 ">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('vendor.products.update', ['product' => $product])}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="quantity" min="1" value="{{old('quantity', $product->quantity)}}" class="form-control">
                    @error('quantity')
                        <code>{{$message}}</code>
                    @enderror
                  </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      $('body').on('change', '.sub-category', function (e){
        ...
        $.ajax({
          method:'GET',
          url: "{{route('vendor.get-child-categories')}}",
          data: {
            id : id
          },
          success: function(data){
