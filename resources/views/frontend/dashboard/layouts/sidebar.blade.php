<div class="dashboard_sidebar">
    ...
    <a href="{{route('index')}}" class="dash_logo"><img src="{{asset('frontend/images/logo.png')}}" alt="logo" class="img-fluid"></a>
    <ul class="dashboard_link">
      ...
      <li><a href="{{route('user.address.index')}}"><i class="fal fa-house"></i> Addresses</a></li>
      <li>
