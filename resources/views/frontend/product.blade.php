                            ...
                            <div class="exzoom hidden" id="exzoom">
                                <div class="exzoom_img_box">
                                    ...
                                    <ul class='exzoom_img_ul'>
                                        ...
                                        <li><img class="zoom ing-fluid w-100" src="{{asset('product/'.$image->image)}}" alt="product"></li>
                    ...
                    <div class="col-xl-5 col-md-7 col-lg-7">
                        <div class="wsus__pro_details_text">
                            ...
                            <p class="wsus__stock_area">
                                ...
                                <span class="in_stock">in stock</span> ({{$product->quantity}} items)
                                @else
                                <span class="out_stock">out of stock</span> ({{$product->quantity}} items)
                                @endif
                            </p>
...
{{-- 
                            ...
                            <form class="shopping-cart-form">
                                ...
                                <ul class="wsus__button_area">
                                    <li><button type="submit" class="add_cart"  {{$product->quantity == 0 ? 'disabled' : ''}}>add to cart</button></li>
                                    <li><a class="buy_now" href="#">buy now</a></li>
                                    <li><a href="#"><i class="fal fa-heart"></i></a></li>
                                    <li><a href="#"><i class="far fa-random"></i></a></li>
                                </ul>
                    ...
                    <div class="col-xl-3 col-md-12 mt-md-5 mt-lg-0">
                        <div class="wsus_pro_det_sidebar" id="sticky_sidebar">
                          ...
                          {{--   <div class="wsus__det_sidebar_banner">
                                <img src="{{asset('images/blog_1.jpg')}}" alt="banner" class="img-fluid w-100">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-xxl-5 col-md-6">
                                                <div class="wsus__vebdor_img">
                                                    <img src="{{asset('vendors/'.$product->vendor->banner)}}" alt="vendor" class="img-fluid w-100">
                                                </div>
                                            </div>
