                        ...
                        <div class="row">
                            <div class="col-xl-6 col-12 col-sm-10 col-md-8 col-lg-6 m-auto display">
                                <div class="wsus__quick_view_img">
                                    <a class="venobox wsus__pro_det_video" id="modal_video" data-autoplay="true" data-vbtype="video"
                                        href="https://youtu.be/7m16dFI1AF8">
                                        <i class="fas fa-play"></i>
                                    </a>
                                    <div class="row modal_slider" id="modal_slider">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-12 col-sm-12 col-md-12 col-lg-6">
                                <div class="wsus__pro_details_text">
                                    <a class="title" href="#" id="modal_product"></a>
                                    <p class="wsus__stock_area" id="modal_stock">
                                    ...
                                    <p class="description" id="modal_desc" ></p>
                                    <form class="shopping-cart-form">
                                        <input type="hidden" name="product_id" id="modal_product_id">
                                        <div class="wsus__selectbox">
                                            <div class="row" id="modal_variant">
                                            </div>
                                        </div>
                                    ...
                                    <p class="brand_model"><span id="modal_sku"></span> </p>
                                    <p class="brand_model"><span id="modal_brand"></span>  </p>
