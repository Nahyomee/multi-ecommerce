                    ...
                    <div class="relative_contect d-flex">
                        ...
                        <ul class="wsus_menu_cat_item show_home toggle_menu">
                            @foreach ($categories as $category)
                                <li><a class="{{$category->activeSubcategories->count() > 0 ? 'wsus__droap_arrow' : ''}}" href="#"><i class="{{$category->icon}}"></i> {{$category->name}} </a>
                                    @if($category->activeSubcategories->count() > 0)
                                    <ul class="wsus_menu_cat_droapdown">
                                        @foreach ($category->activeSubcategories as $subcategory)
                                        <li><a href="#">{{$subcategory->name}} <i class="{{$subcategory->activeChildCategories->count() > 0 ? 'fas fa-angle-right' : ''}}"></i></a>
                                            @if($subcategory->activeChildCategories->count() > 0)
                                            <ul class="wsus__sub_category">
                                                @foreach ($subcategory->activeChildCategories as $child_category)
                        ...
                        <ul class="wsus__menu_item">
                            ...
                            <li><a href="{{route('products')}}">shop <i class="fas fa-caret-down"></i></a>
                        ...
                        <ul class="wsus__menu_item wsus__menu_item_right">
                            ...
                            <li>
                                @auth
                                   ...
                                   <a href="{{route('vendor.dashboard')}}">my account</a>
                ...
                <div class="wsus__mobile_menu_main_menu">
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <ul class="wsus_mobile_menu_category">
                            ...
                            <li><a href="#" class="{{$categoryItem->activeSubcategories->count() > 0 ? 'accordion-button collapsed' : ''}}" data-bs-toggle="collapse"
                                ...
                                @if($categoryItem->activeSubcategories->count() > 0)
                                <div id="flush-collapseThreew-{{$loop->index}}" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        @foreach ($categoryItem->activeSubcategories as $subcategoryItem)
                                        <ul>
                                ...
                                <div id="flush-collapseThree101" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <ul>
                                            ...
                                            <li><a href="about_us.html">about</a></li>
                                            <li><a href="team.html">team</a></li>
                                            <li><a href="{{route('products')}}">product grid view</a></li>
                                            <li><a href="{{route('products')}}">product list view</a></li>
