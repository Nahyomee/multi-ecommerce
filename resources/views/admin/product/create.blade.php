            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.products.store')}}" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="offer_start" value="{{old('offer_start')}}" class="form-control datepicker">
                        @error('offer_start')
                            <code>{{$message}}</code>
                        @enderror
                      </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="offer_end" value="{{old('offer_end')}}" class="form-control datepicker">
                        @error('offer_end')
                            <code>{{$message}}</code>
                        @enderror
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="quantity" min="0" value="{{old('quantity')}}" class="form-control">
                    @error('quantity')
                        <code>{{$message}}</code>
                    @enderror
                  </div>
