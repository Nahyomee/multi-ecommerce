...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{route('admin.variants.items.index', ['variant' => $variant])}}">{{$variant->name}} Items</a></div>
        ...
        <div class="col-12 ">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.variants.items.update', ['variant' => $variant, 'item' => $item])}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
