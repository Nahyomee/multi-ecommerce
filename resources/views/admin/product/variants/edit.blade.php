...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{route('admin.products.variants.index', ['product' => $product])}}">{{$product->name}} Variants</a></div>
        ...
        <div class="col-12 ">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.products.variants.update', ['product' => $product, 'variant' => $variant])}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
