...
<section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Create Child Category</div>
      </div>
    </div>

    <div class="section-body">
      <h2 class="section-title">Create Child Category</h2>
        ...
        <div class="col-12 ">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.child-categories.store')}}" enctype="multipart/form-data">
                    @csrf
