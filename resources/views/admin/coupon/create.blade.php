            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('admin.coupons.store')}}">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="max_use" value="{{old('max_use')}}" class="form-control">
                      @error('max_use')
                          <code>{{$message}}</code>
                      @enderror
                    </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="discount_type" class="form-control select2">
                              ...
                              <option value="amount" @selected(old('discount_type') == 'amount')>Amount ({{$settings->currency_icon}})</option>
                            </select>
                            @error('discount_type')
                                <code>{{$message}}</code>
                            @enderror
